...
- Native `.drawio` files are the authoritative diagrams.
...
Start with [`TODO.md`](TODO.md), then read [`source-baseline.md`](source-baseline.md) and [`CONTRIBUTING.md`](CONTRIBUTING.md).

## Flow documents

- [System overview](flows/00-system-overview.md)
